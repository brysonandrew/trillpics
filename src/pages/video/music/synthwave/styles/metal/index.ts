...
export const metalBorderStyle = css`
  box-shadow: inset ${FADE_15_1} 0 0px 0px 4px,
    /* border */ inset ${FADE_15_08} 0 -1px 5px 4px,
    /* soft SD */ inset ${FADE_0_025} 0 -1px 0px 7px,
    /* bottom SD */ inset ${FADE_100_07} 0 2px 1px 7px;
`;

export const metalBorderActiveStyle = css`
  box-shadow: inset rgba(255, 0, 0, 0.1) 0 0px 0px 4px,
    /* border */ inset rgba(255, 0, 0, 0.1) 0 -1px 5px 4px,
    /* soft SD */ inset rgba(255, 0, 0, 0.1) 0 -1px 0px 7px,
    /* bottom SD */ inset rgba(255, 0, 0, 0.1) 0 2px 1px 7px;
`;
