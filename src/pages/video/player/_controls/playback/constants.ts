export const DEFAULT_CANVAS_COLOR =
  "#141322";
...
export const DEFAULT_ASPECT_RATIO: TDimensionsFromAspectRatioLookupKey =
  "16:9";
...
export const PRESIGNED_UPLOAD_URL_VALIDITY_IN_SECONDS =
  60 * 2; // 2 Minutes
export const PRESIGNED_GET_URL_VALIDITY_IN_SECONDS =
  60 * 120; // 120 Minutes
