import { ECustomWave } from "~/hooks/music/midis/oscillators/constants";
import {
  generateWave,
  blackmanWave,
  parabolaWave,
  ...
  sharkFinn,
  generateBasicWave,
} from "~/hooks/music/midis/oscillators/utils";
import { BASS_WAVE } from "~/hooks/music/midis/oscillators/wave-presets/bass";
import { BELL_WAVE } from "~/hooks/music/midis/oscillators/wave-presets/bell";
import { BRASS_WAVE } from "~/hooks/music/midis/oscillators/wave-presets/brass";
import { CHIME } from "~/hooks/music/midis/oscillators/wave-presets/chime";
import { GONG_WAVE } from "~/hooks/music/midis/oscillators/wave-presets/gong";
import { HORN_WAVE } from "~/hooks/music/midis/oscillators/wave-presets/horn";
import { ORGAN } from "~/hooks/music/midis/oscillators/wave-presets/organ";
import { ORGAN_II } from "~/hooks/music/midis/oscillators/wave-presets/organ-II";
import { ORGAN_III } from "~/hooks/music/midis/oscillators/wave-presets/organ-III";
import { STEEL_DRUM } from "~/hooks/music/midis/oscillators/wave-presets/steel-drum";
import { TUBULAR } from "~/hooks/music/midis/oscillators/wave-presets/tubular";
import { TUBULAR_II } from "~/hooks/music/midis/oscillators/wave-presets/tubular-II";
