...
import { MIN_DEVICE_WIDTH } from "~/shell/init/hooks/measure/measure";
    ...
    return (
      <>
        <LayoutOverlay 
          ...
          direction="rtl"
          subtitle={`Your device's viewport is too small to use this app. Your device must have a screen of at least "${MIN_DEVICE_WIDTH}px" wide.`}
        >
          Screen too small
        </LayoutOverlay>
      </>
